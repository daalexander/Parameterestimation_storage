...
for k,e in enumerate(int_start):
    ...
    x4_init = data["TSH0_1"].values[e:int_end[k]:int_step]
    x5_init = data["TSH0_2"].values[e:int_end[k]:int_step]
    x6_init = data["TSH2_1"].values[e:int_end[k]:int_step]
    x7_init = data["TSH2_2"].values[e:int_end[k]:int_step]
    x8_init = data["TSH3_1"].values[e:int_end[k]:int_step]
    x9_init = data["TSH3_2"].values[e:int_end[k]:int_step] 
    ...
    ydata_4 = data["TSH0_1"].values[e:int_end[k]:int_step]
    ydata_5 = data["TSH0_2"].values[e:int_end[k]:int_step]
    ydata_6 = data["TSH2_1"].values[e:int_end[k]:int_step] 
    ydata_7 = data["TSH2_2"].values[e:int_end[k]:int_step]
    ydata_8 = data["TSH3_1"].values[e:int_end[k]:int_step]
    ydata_9 = data["TSH3_2"].values[e:int_end[k]:int_step] 
